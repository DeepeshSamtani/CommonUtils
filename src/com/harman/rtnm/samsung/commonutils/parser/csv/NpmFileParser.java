 ...
 *
 */
public final class NpmFileParser implements IParser {
	...
	/**
	 * Constructor for initializing the NpmFileParser</br>
	 ...
	 */
	public NpmFileParser(String filePathName) throws FileNotFoundException, IOException {
		this(filePathName, "");
	 ...
	 * @throws FileNotFoundException
	 */
	public NpmFileParser(String filePathName, String delimiter) throws FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public NpmFileParser(String filePathName, String delimiter , Boolean isIncludeColumnsWithEmptyValue) throws FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public NpmFileParser(String filePathName, String delimiter , Boolean shouldIncludeColumnsWithEmptyValue, boolean isEnableIndexing, int[] keyColumns) throws FileNotFoundException, IOException {
	...
	/**
	 * Constructor for initializing the NpmFileParser 
	 ...
	 * @throws FileNotFoundException 
	 */
	public NpmFileParser(String filePathName, String delimiter, int batchSize) throws FileNotFoundException, IOException {
	 ...
	 * @throws FileNotFoundException
	 */
	public NpmFileParser(File file, String delimiter) throws FileNotFoundException {
	 ...
	 * @throws FileNotFoundException
	 */
	public NpmFileParser(File file, String delimeter, int batchSize, boolean shouldIncludeColumnsWithEmptyValue, boolean isCreateIndexesEnabled, int[] keyColumns) throws FileNotFoundException {
		if(file == null ) {
	...
	/**
	 * Create a new {@link NpmFileParser} from the existing one for reading different file with provided delimiter
	 * @param file
	 * @param delimiter
	 * @return
	 * @throws IOException
	 */
	public NpmFileParser createReader(File file, String delimiter) throws IOException {
		close();
		return (new NpmFileParser(file, delimiter));
	}
	 ...
	 * It will be having any records if indexing is enable or createIndexTable is called atleast once with this {@link NpmFileParser} instance.
	 * @return
	 */
