...
/**
 * Object to hold the properties of a device and interface
 *
 */
public final class RowConfig implements Serializable {
	...
	private MultiKeyMap mapMultiKeysToColumn = new MultiKeyMap();
	/**
	...
	/**
	 * Get the index for a property/column in the header
	 * @param key1
	 * @param key2
	 * @return
	 */
	public int getIndex(String key1, String key2) {
		return getIndex(StringUtils.stringValueOf(mapMultiKeysToColumn.get(key1, key2)));
	}
	...
	/**
	 * 
	 * @param mapMultiKeysRelation
	 */
	public void setMultiKeysToColumnHeaderMapping(MultiKeyMap mapMultiKeysRelation) {		
		this.mapMultiKeysToColumn = mapMultiKeysRelation;
	}
