...
/**
 * Row object to hold all the properties' values of an Element or Subelement
 */
/*
 * This object is capable of supporting threaded tree structure but not being used as such currently
 * as the serialization cost would be really high as compared to serialinzing the String
 * as part of IndexTable serialization for all the inventory processing flows supporting 
 * Delta creation.
 */
public final class Row implements Serializable {
	...
	/**
	 * Set the value of the column, where the column name is header is mapped to multiple keys
	 * @param key1
	 * @param key2
	 * @param value
	 */
	public void setColumnValue(String key1, String key2, String value) {
		int index = rowConfig.getIndex(key1, key2);
	...
	/**
	 * Get value of type String for the specified property mapped to 
	 * two keys.
	 * @param key1
	 * @param key2
	 * @return
	 */
	public String getColumnValue(String key1, String key2) {
		int index = rowConfig.getIndex(key1, key2);
		if(index != Integer.MIN_VALUE) { 
	...
	/**
	 * Return the String properties delimited by {@link StringUtils}.DELIMITER_SYMBOL_CIDLA character
	 */
