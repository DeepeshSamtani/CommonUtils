 ...
 * It creates the file based on given file path or file object, if it does not exist already. Auto flush flag ensures of writting the data to the file at the earliest with best efforts.</br>
 * <b>NOTE</b>: It is not thread-safe and uses NIO.
 *
 */
public final class NpmFileWriter implements IWriter {
	 ...
	 * @throws IOException
	 */
	public NpmFileWriter(String filePath) throws IOException {
		this(filePath, false);
	}
	 ...
	 * @throws IOException
	 */
	public NpmFileWriter(String filePath, boolean append) throws IOException {
	 ...
	 * @throws IOException
	 */
	public NpmFileWriter(File file) throws FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public NpmFileWriter(String file, boolean append, byte dataWriteSize) throws FileNotFoundException, IOException {		
	 ...
	 * @throws IOException
	 */
	public NpmFileWriter(File file, boolean append, byte dataWriteSize) throws FileNotFoundException, IOException {
...
//	}
	...
	/**
	 * This method handles the logic of storing the data locally and writing it in blocks.
	 * It will create the index of each record being written to the file system byte array and store it into the given IndexTable
	 * @param record
	 * @param key
	 * @param indexTable
	 * @throws IOException
	...
	public void writeAndIndex(String record, Object key, IndexTable<Object, Object> indexTable) throws IOException {
		...
		indexTable.put(key, new Long(recordIndex));
